...
# Import height and velocity functions of time from freefall_kinematics.py
# Definethe array oftimes from 0 to 2 v_0/g
...
def potential_energy(height, mass, gravitational_acceleration=9.8):
  return mass * gravitational_acceleration * height


def calculate_energies(mass, initial_height, initial_velocity, number_of_times, gravitational_acceleration):
...
if __name__ == '__main__':
  ...
  times_and_energies = (object_mass, starting_height, starting_velocity,  time_sample_number)
